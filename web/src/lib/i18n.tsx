...
const AR: Record<string, string> = {
  ...
  'rateForm.structuredChildPolicy': 'سياسة أطفال منظمة',
  'rateForm.noStructuredPolicy': 'بدون سياسة منظمة',
  ...
  'import.expectedCols': 'أعمدة متوقعة: hotel_name، region، room_type، meal_plan، adult_price، child_policy_code، date_from، date_to…',
...
const EN: Record<string, string> = {
  ...
  'rateForm.structuredChildPolicy': 'Structured child policy',
  'rateForm.noStructuredPolicy': 'No structured policy',
  ...
  'import.expectedCols': 'Expected columns: hotel_name, region, room_type, meal_plan, adult_price, child_policy_code, date_from, date_to…',
